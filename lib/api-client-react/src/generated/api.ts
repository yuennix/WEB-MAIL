...
export const getGetEmailUrl = (id: string,
  ...
  return stringifiedParams.length > 0 ? `/api/emails/${id}?${stringifiedParams}` : `/api/emails/${id}`
}
...
export const getEmail = async (id: string,
    params: GetEmailParams, options?: RequestInit): Promise<EmailDetail> => {
...
export const getGetEmailQueryKey = (id: string,
    params?: GetEmailParams,) => {
    return [
    `/api/emails/${id}`, ...(params ? [params] : [])
    ] as const;
    }


export const getGetEmailQueryOptions = <TData = Awaited<ReturnType<typeof getEmail>>, TError = ErrorType<ErrorResponse>>(id: string,
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetEmailQueryKey(id,params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getEmail>>> = ({ signal }) => getEmail(id,params, { signal, ...requestOptions });
 ...
 */
export const listDomains = async ( options?: RequestInit): Promise<DomainList> => {
 ...
 */
export const addDomain = async (addDomainBody: AddDomainBody, options?: RequestInit): Promise<Domain> => {
...
export const getAddDomainMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof addDomain>>, TError,{data: BodyType<AddDomainBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof addDomain>>, TError,{data: BodyType<AddDomainBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof addDomain>>, {data: BodyType<AddDomainBody>}> = (props) => {
          const {data} = props ?? {};
...
export const updateDomain = async (id: number,
    updateDomainBody: UpdateDomainBody, options?: RequestInit): Promise<Domain> => {
...
export const getUpdateDomainMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateDomain>>, TError,{id: number;data: BodyType<UpdateDomainBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateDomain>>, TError,{id: number;data: BodyType<UpdateDomainBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateDomain>>, {id: number;data: BodyType<UpdateDomainBody>}> = (props) => {
          const {id,data} = props ?? {};
 ...
 * @summary Update a domain
 */
export const useUpdateDomain = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateDomain>>, TError,{id: number;data: BodyType<UpdateDomainBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const getGetEmailStatsUrl = (params: GetEmailStatsParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/api/emails/stats?${stringifiedParams}` : `/api/emails/stats`
}
 ...
 */
export const getEmailStats = async (params: GetEmailStatsParams, options?: RequestInit): Promise<EmailStats> => {
...
export const getGetEmailStatsQueryKey = (params?: GetEmailStatsParams,) => {
    return [
    `/api/emails/stats`, ...(params ? [params] : [])
    ] as const;
    }


export const getGetEmailStatsQueryOptions = <TData = Awaited<ReturnType<typeof getEmailStats>>, TError = ErrorType<unknown>>(params: GetEmailStatsParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getEmailStats>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetEmailStatsQueryKey(params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getEmailStats>>> = ({ signal }) => getEmailStats(params, { signal, ...requestOptions });
...
export function useGetEmailStats<TData = Awaited<ReturnType<typeof getEmailStats>>, TError = ErrorType<unknown>>(
 params: GetEmailStatsParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getEmailStats>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
