      ...
      <div className="flex flex-col justify-center w-full md:w-1/2 px-8 md:px-16 py-12 space-y-8">
        ...
        <div className="space-y-4">
          ...
          <h1 className="text-3xl md:text-4xl font-extrabold text-white leading-tight">
            Receive Emails on Your<br />Custom Domain — Instantly.
          </h1>
          <p className="text-white/75 text-sm md:text-base leading-relaxed max-w-md">
            Weyn Emails lets you catch any email sent to <strong>@weyn.store</strong> or <strong>@jhames.shop</strong>. No setup needed — just type an alias and start receiving right away.
          </p>
