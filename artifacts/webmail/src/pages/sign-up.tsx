        ...
        <div className="relative z-10 space-y-6 py-8 md:py-0">
          <div>
            ...
            <h1 className="text-3xl md:text-4xl font-extrabold leading-tight">
              Your Own Email on<br />
              <span className="text-violet-200">weyn.store</span> &amp;<br />
              <span className="text-violet-200">jhames.shop</span>
            </h1>
            <p className="mt-4 text-white/75 text-sm md:text-base leading-relaxed max-w-md">
              Create a free account and start catching emails at any alias — like <strong>yourname@weyn.store</strong>. No DNS setup. No waiting. Just type and receive.
            </p>
          </div>

          {/* Tier breakdown */}
          <div className="space-y-3">
            <p className="text-white/60 text-xs font-semibold uppercase tracking-widest">What you get</p>
            ...
            <div className="flex items-start gap-3 bg-white/10 backdrop-blur rounded-xl p-4 border border-white/20">
              ...
              <div>
                <p className="font-bold text-sm">FREE Account</p>
                <p className="text-white/70 text-xs mt-0.5 leading-relaxed">
                  Get started instantly. View Facebook security code emails — 8-digit verification codes delivered right to your inbox.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 bg-white/15 backdrop-blur rounded-xl p-4 border border-violet-300/30">
              ...
              <div>
                <p className="font-bold text-sm text-yellow-200">PREMIUM ⭐ — Full Access</p>
                <p className="text-white/70 text-xs mt-0.5 leading-relaxed">
                  Unlock <strong className="text-white">all emails</strong> from any sender, unlimited — no filters, no restrictions. Full inbox access around the clock.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="flex flex-1 items-center justify-center bg-background p-6 md:p-12">
        <div className="w-full max-w-sm">
          <div className="mb-6">
            ...
            <p className="text-muted-foreground text-sm mt-1">Join Weyn Emails and start receiving on your domain</p>
          </div>
          <SignUp
            routing="path"
